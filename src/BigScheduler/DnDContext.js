    ...
    return {
      drop: (props, monitor, component) => {
        ...
        if (type === DnDTypes.EVENT) {
          ...
          if (cellUnit !== CellUnit.Hour)
            initialEndTime = localeDayjs(
              new Date(resourceEvents.headerItems[initialLeftIndex].start)
            )
              .hour(23)
              .minute(59)
              .second(59)
      ...
      hover: (props, monitor, component) => {
        ...
        if (type === DnDTypes.EVENT) {
          ...
          if (cellUnit !== CellUnit.Hour)
            initialEnd = localeDayjs(new Date(resourceEvents.headerItems[initialLeftIndex].start))
              .hour(23)
              .minute(59)
              .second(59)
              .format(DATETIME_FORMAT)
